# Series 10: Queue & Stack Maps for Packet Shapers

[![PDF Guide](https://img.shields.io/badge/PDF-Download-red?logo=adobe-acrobat-reader)](./series-10.pdf)
[![eBPF](https://img.shields.io/badge/eBPF-Kernel_Hook-orange)](https://ebpf.io/)

## What You Will Build

Enforce per-pod bandwidth caps using TC BPF + Queue maps as a token bucket. FIFO ordering ensures no connection starvation.

## Real-World Usage

Used in production by: **Cilium Bandwidth Manager, Netflix per-tenant rate limiting**
...
| File | Description |
|:-----|:------------|
| `series-10.pdf` | Full lesson PDF with architecture diagrams, code walkthrough, debugging guide |
...
Open [series-10.pdf](./series-10.pdf) for:
