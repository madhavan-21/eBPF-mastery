...
[![PDF Guide](https://img.shields.io/badge/PDF-Download-red?logo=adobe-acrobat-reader)](./series-09.pdf)
[![eBPF](https://img.shields.io/badge/eBPF-Kernel_Hook-orange)](https://ebpf.io/)

## What You Will Build

Atomically swap entire routing tables in one syscall using Map-in-Map. Zero packet inconsistency during Kubernetes policy rollouts.

## Real-World Usage

Used in production by: **Cilium network policy engine, Isovalent eBPF CNI**

## BPF Hook

```
xdp (ARRAY_OF_MAPS routing)
```
...
| File | Description |
|:-----|:------------|
| `series-09.pdf` | Full lesson PDF with architecture diagrams, code walkthrough, debugging guide |
...
sudo ./loader\n# Watch routing swap after 5 seconds\n# sudo cat /sys/kernel/debug/tracing/trace_pipe
```

## Read the Full Lesson

Open [series-09.pdf](./series-09.pdf) for:
